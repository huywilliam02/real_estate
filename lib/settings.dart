...
class AppSettings {
  ///Basic Settings
  static const String applicationName = 'CIT Bất động sản';
  static const String androidPackageName = 'com.citgroupvn.bds';
  ...
  ///API Setting
  static const String hostUrl = "https://admin.bds.citgroup.vn/";
...
it will call API in background without showing the process and when data available it will replace it with new data */
  ...
  ///Native deep link
  static const String shareNavigationWebUrl = "admin.bds.citgroup.vn";
